...
/**
 * Localizable action that calls the exit() method of the {@link Notepad}.
 * 
 * <p>
 * Requires the localization of following keys: exit.name - name of the action,
 * exit.desc - tooltip of the action.
 * </p>
 * 
...
public class ExitAction extends LocalizableAction {
	 ...
	 */
	private static final String NAME_KEY = "exit.name";

	/**
	 * Localization key of the action description tooltip.
	 */
	private static final String DESC_KEY = "exit.desc";
	 ...
	 */
	public ExitAction(Notepad notepad, ILocalizationProvider provider) {
